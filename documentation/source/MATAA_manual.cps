...
\entry {MATAA documentation}{4}
\entry {MATAA scripts}{4}
\entry {MATAA settings/preferences}{4}
\entry {MATAA tools}{4}
...
\entry {Setup, sound hardware}{6}
\entry {Signal path}{5}
\entry {Sound hardware setup}{6}
\entry {Soundcard}{7}
...
\entry {Test signal files, default path}{4}
\entry {Test signal path}{5}
\entry {TestDevices}{4, 7, 12}
